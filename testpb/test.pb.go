...
func (x *SetTestRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetTestRequest) ProtoMessage() {}

func (x *SetTestRequest) ProtoReflect() protoreflect.Message {
	mi := &file_testpb_test_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetTestRequest.ProtoReflect.Descriptor instead.
func (*SetTestRequest) Descriptor() ([]byte, []int) {
	return file_testpb_test_proto_rawDescGZIP(), []int{2}
}

func (x *SetTestRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SetTestRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_testpb_test_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x34, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x54, 0x65,
	...
	,
}
...
var file_testpb_test_proto_goTypes = []interface{}{
	...
	(*SetTestRequest)(nil), // 2: test.SetTestRequest
}
var file_testpb_test_proto_depIdxs = []int32{
	...
	2, // 3: test.TestService.SetTest:output_type -> test.SetTestRequest
