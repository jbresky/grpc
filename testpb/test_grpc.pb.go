...
type TestServiceClient interface {
	...
	SetTest(ctx context.Context, in *Test, opts ...grpc.CallOption) (*SetTestRequest, error)
}
...
func (c *testServiceClient) SetTest(ctx context.Context, in *Test, opts ...grpc.CallOption) (*SetTestRequest, error) {
	out := new(SetTestRequest)
...
type TestServiceServer interface {
	...
	SetTest(context.Context, *Test) (*SetTestRequest, error)
...
func (UnimplementedTestServiceServer) SetTest(context.Context, *Test) (*SetTestRequest, error) {
